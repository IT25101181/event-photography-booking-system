...
@REM check for pre script, once with legacy .bat suffix and once with .cmd suffix
...
@REM Begin all vars with MAVEN_
set MAVEN_EXECUTABLE=mvn.cmd
...
@REM Execute Maven
"%MAVEN_HOME%\bin\%MAVEN_EXECUTABLE%" %*
